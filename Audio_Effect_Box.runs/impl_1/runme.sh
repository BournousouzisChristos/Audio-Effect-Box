...
HD_PWD='C:/Users/Christos/Desktop/Projet/Audio_Effect_Box/Audio_Effect_Box.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Audio_Effect_Box_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Audio_Effect_Box_wrapper.tcl -notrace

...
HD_PWD='C:/Users/Quinaux/Desktop/Projet/Audio-Effect-Box/Audio_Effect_Box.runs/Audio_Effect_Box_axi_iic_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Audio_Effect_Box_axi_iic_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Audio_Effect_Box_axi_iic_0_0.tcl

...
HD_PWD='C:/Users/Christos/Desktop/Projet/Audio_Effect_Box/Audio_Effect_Box.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Audio_Effect_Box_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Audio_Effect_Box_wrapper.tcl

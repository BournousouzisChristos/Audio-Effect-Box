...
synth_design -top Audio_Effect_Box_wrapper -part xc7z020clg400-1
...
write_checkpoint -force -noxdef Audio_Effect_Box_wrapper.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file Audio_Effect_Box_wrapper_utilization_synth.rpt -pb Audio_Effect_Box_wrapper_utilization_synth.pb"
